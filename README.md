...
<sub>Generated by a [custom script](./scripts/generate_stats.py) that runs daily via GitHub Actions — pulled straight from the GitHub API, no third-party rendering service involved.</sub>
